...
doVB_pois_sp3 <- function(N, yv, xi, xp, varind, xi0, xp0, D, L, iter, a, b, V, display_progress) {
    .Call(`_moltenNMF_doVB_pois_sp3`, N, yv, xi, xp, varind, xi0, xp0, D, L, iter, a, b, V, display_progress)
}
