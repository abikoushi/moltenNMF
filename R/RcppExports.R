...
doSVB_pois_sp_skip <- function(N, yv, xi, xp, varind, N0, D, L, iter, a, b, V, bsize, lr_param, lr_type, display_progress) {
    .Call(`_moltenNMF_doSVB_pois_sp_skip`, N, yv, xi, xp, varind, N0, D, L, iter, a, b, V, bsize, lr_param, lr_type, display_progress)
}
